...
<%--                                <th>passwork</th>--%>
                          ...
                          <c:forEach items="${listUser}" var="use">
                                <tr>
                                    <td>${use.userId}</td>
                                    <td>${use.userName}</td>
                                    <td>${use.email}</td>
<%--                                    <td>${use.passWork}</td>--%>
                                    ...
                                    <td>${use.userStatus?'hoạt động':'bị khóa'}</td>
                                    <td>${use.permission}</td>

                                    <td>
                                        <a href="<%=request.getContextPath()%>/UserServlet?action=unlock&&userId=${use.userId}">
                                            <button name="action" value="unlock"  type="button" class="btn btn-success">Unlock</button>
                                        </a>

                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/UserServlet?action=lock&&userId=${use.userId}">
                                            <button name="action" value="lock" type="button" class="btn btn-danger">Lock</button>
                                        </a>
