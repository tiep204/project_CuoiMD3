                ...
                <form action="<%=request.getContextPath()%>/ProductServlet" method="post" enctype="multipart/form-data">
                    <table border="1px solid black">
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="quantity" value="${productUpdate.quantity}"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img style="width: 100px;height:100px;" src="/images/${productUpdate.productImage}"
                                     alt="${productUpdate.productImage}"></td>
                            <input type="hidden" name="productImageOld" value="${productUpdate.productImage}">
                        </tr>
                        <tr>
                            <td>Ảnh phụ</td>
                            <td><input type="file" name="subImage" multiple/></td>
                        </tr>
                        <tr>
                            <td>Trạng Thái</td>
                            <td>
                                <input type="radio" name="status" id="active" value="true"
                                       checked="${productUpdate.productStatus?'checked':''}"/><label
                                    for="active">còn hàng</label>
                                <input type="radio" name="status" id="inactive" value="false"
                                       checked="${productUpdate.productStatus==false?'checked':''}"/><label
                                    for="inactive">hết hàng</label>
                            </td>
                        </tr>
                        <tr>
                            <td>chọn danh mục</td>
                            <td>
                                <select id="categoriesId" name="catalog">
                                    <c:forEach items="${listCatalog}" var="cat">
                                        <option value="${cat.catalogId}" ${cat.catalogId==productUpdate.catalogId?'selected':''}>${cat.catalogName}</option>
                                    </c:forEach>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td>mô tả sản pham</td>
                            <td><textarea name="descriptions" id="descriptions">${productUpdate.descriptions}</textarea>
                            </td>
                        </tr>
