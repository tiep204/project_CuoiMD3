                ...
                <div class="col-12 col-lg-7">
                    <div class="single_product_thumb">
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            <div>
                                <img style="width: 600px;height: 450px" src="<%=request.getContextPath()%>/images/${pro.productImage}" alt="${pro.productName}">
                            </div>
                            <div>
                                <c:forEach items="${pro.listImage}" var="imagelink">
                                    <img style="height: 200px;width: 200px" src="<%=request.getContextPath()%>/images/${imagelink}" alt=""/>
                                </c:forEach>
                            </div>
                        </div>
                    </div>
...
<%--                                </div>--%>
                            ...
                            <!-- Avaiable -->
                            <p class="avaibility"><i class="fa fa-circle"></i>${pro.productStatus}</p>
                        </div>
