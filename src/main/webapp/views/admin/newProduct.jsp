                ...
                <form action="<%=request.getContextPath()%>/ProductServlet" method="post" enctype="multipart/form-data">
                    <table border="1">
                        ...
                        <tr>
                            <td>Trạng thái</td>
                            <td>
                                <input type="radio" name="status" id="active" value="true"><label
                                    for="active">còn hàng</label>
                                <input type="radio" name="status" id="inactive" value="false"/><label
                                    for="inactive">hết hàng</label>
                            </td>
<%--                            <td><input type="radio" name="productStatus" id="Còn hàng"/>--%>
<%--                                <input type="radio" name="productStatus" id="Hết Hàng"></td>--%>
