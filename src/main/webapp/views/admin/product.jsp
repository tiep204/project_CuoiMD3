                        ...
                        <nav class="navbar navbar-expand-lg bg-light">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="<%=request.getContextPath()%>/ProductServlet?action=newProduct"
                                   methods="post" enctype="multipart/form-data" >
                                    <button type="button" class="btn btn-success" aria-labelledby="newCatalogLabel">+  Add new Product
                                    </button>
                                </a>
                                <form class="d-flex" role="search">
                                    <input class="form-control me-2 fst-italic" name="searchName" type="search"
...
<%--                                    <td>${pro.price}</td>--%>
                                    <td><img style="width: 100px;height: 100px" src="/images/${pro.productImage}" alt=""></td>
                                    <td>${pro.quantity}</td>
                                    <td>${pro.title}</td>
...
<%--                                    <td>${pro.descriptions}</td>--%>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/ProductServlet?action=update&&productId=${pro.productId}">
                                        <button type="button" class="btn btn-warning">Edit</button>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/ProductServlet?action=delete&&productId=${pro.productId}"> <button type="button" class="btn btn-danger" >Delete</button></a>

                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/ProductServlet?action=finById&&productId=${pro.productId}">
