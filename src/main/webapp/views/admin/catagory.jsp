                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listCatalog}" var="cat">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<%=request.getContextPath()%>/CatalogServlet?action=update&&catalogId=${cat.catalogId}" ><button id="updatecatalog" name="action" value="update" type="button" class="btn btn-warning">Edit</button></a>
                                    </td>
                                    <td>
                                        <a href="<%=request.getContextPath()%>/CatalogServlet?action=delete&&catalogId=${cat.catalogId}"><button name="action" value="delete" type="button" class="btn btn-danger">Delete</button></a>
                                    </td>
                                </tr>
                            </c:forEach>
